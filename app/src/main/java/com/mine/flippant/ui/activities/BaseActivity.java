...
import com.mine.flippant.core.ApplicationSessionStateCallback;
...
public class BaseActivity extends AppCompatActivity implements ApplicationSessionStateCallback {
    ...
    protected static QBUser currentUser ;
    ...
    public boolean isSessionActive() {
        Log.d(TAG, "isSessionActive: " + sessionActive);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            ...
            sessionActive = true;
            Log.d(TAG, "onCreate: sessionActive = true");
        }
    ...
    private void recreateSession(final QBUser user){
        ...
        ChatService.getInstance().login(user, new QBEntityCallback<Void>() {
            ...
            public void onSuccess(Void result, Bundle bundle) {
                ...
                sessionActive = true;
                Log.d(TAG, "recreateSession(): sessionActive = true");
